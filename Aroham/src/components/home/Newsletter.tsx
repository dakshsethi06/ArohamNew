...
export function Newsletter() {
  ...
  return (
    <section className="py-10 sm:py-16 px-4 sm:px-6 lg:px-10" style={{ background: "#FAF7F2" }}>
      <div className="max-w-2xl mx-auto text-center">
        <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">ॐ</div>
        <h2 className="mb-2 sm:mb-3" style={{ fontFamily: SERIF, fontSize: "clamp(1.5rem,4vw,2.5rem)", fontWeight: 500, color: MAROON, lineHeight: 1.2 }}>
          Join India's Spiritual Community
        </h2>
        <p className="text-xs sm:text-sm mb-5 sm:mb-8" style={{ color: "#7A6A58" }}>Auspicious dates, Vedic wisdom, exclusive offers &amp; early access to new products.</p>
        {joined ? (
