...
import { MAROON, GOLD, SAFFRON, IVORY, SANS, SERIF } from "@logic/constants/theme";
import { CONTACT_INFO } from "@logic/constants/contact";
import { pyramidImg, baglaImg, navratnaImg, gemstonImg, yantraPlateImg, pendantSilImg } from "@logic/constants/data";
