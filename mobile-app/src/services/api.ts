import { ArohamProduct, Astrologer, Order, Message } from '../types';
import { supabase } from './supabase';

const API_BASE = 'https://aroham.onrender.com/api';
...
function isAstrologerActive(isOnline: boolean, workingHours: any) {
...
export async function fetchProducts(): Promise<ArohamProduct[]> {
  try {
